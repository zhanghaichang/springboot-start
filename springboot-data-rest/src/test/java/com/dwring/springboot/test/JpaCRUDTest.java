...
public class JpaCRUDTest {
	...
	public void saveTest() {
		...
		Assert.assertEquals("王重阳", userInfoService.loadById(1L).getRealname());
		System.out.println(userInfoService.loadById(1L).getRealname());
	}

	@Test
	public void loadTest() {
		UserInfo userInfo = userInfoService.loadById(1L);
