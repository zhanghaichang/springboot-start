...
Source Database       : crc_tenant_104

Target Server Type    : MYSQL
Target Server Version : 50712
File Encoding         : 65001

Date: 2017-07-06 11:20:00
*/
...
CREATE TABLE `sys_tenant_datasource` (
  ...
  PRIMARY KEY (`td_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='租户数据源映射表';

-- ----------------------------
-- Records of sys_tenant_datasource
-- ----------------------------
INSERT INTO `sys_tenant_datasource` VALUES ('1', '1', 'dataSource');
INSERT INTO `sys_tenant_datasource` VALUES ('2', '2', 'crc1');
INSERT INTO `sys_tenant_datasource` VALUES ('3', '3', 'crc2');
INSERT INTO `sys_tenant_datasource` VALUES ('4', '4', 'crc3');
...
-- ----------------------------
INSERT INTO `t_student` VALUES ('41', 'lisi', '25', 'nanjing');
...
-- ----------------------------
INSERT INTO `user_info` VALUES ('1', 'crc_tenant_104', '12345678', '1', null, null, null, null, null);
