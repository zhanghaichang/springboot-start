...
import com.dwring.springboot.security.MyShiroCasRealm;
import com.dwring.springboot.service.StudentService;

/**
 * @Title: ShiroCasConfiguration.java
 * @Package com.qf.springboot.config
 * @Description: Shiro集成Cas配置
 * @author haichangzhang
 * @date 2017年7月10日 下午4:52:49
 * @version V1.0
 */
@Configuration
public class ShiroCasConfiguration {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,
			CasFilter casFilter, StudentService stuService) {
