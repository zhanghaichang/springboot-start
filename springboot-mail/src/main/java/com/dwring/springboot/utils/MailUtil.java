...
public class MailUtil {
    ...
    public void sendHTMLMail(MailBean mailBean) {
        ...
        try {
            ...
            mimeMessageHelper.setText(mailBean.getHtmlText(), true);
    ...
    public void sendTemplateMail(MailBean mailBean) {
        ...
        try {
            ...
            Template template = configuration.getTemplate("mail_code_template.ftl");
            String text = FreeMarkerTemplateUtils.processTemplateIntoString(template, model);
            
            //文件路径
            FileSystemResource file = new FileSystemResource(new File("target/HelloWorld_CN_HTML_FREEMARKER.pdf"));
            mimeMessageHelper.addAttachment("demo.pdf", file);
